...
print(paste("The new mean is: ", mean(final_value))) #This is the mean and standard deviation of the final money
...
bi_data <- dbinom(1:20, n, p) #A little help from Pernilles code
